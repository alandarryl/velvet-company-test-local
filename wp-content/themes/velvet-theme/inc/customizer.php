...
function velvet_theme_customize_preview_js() {
	wp_enqueue_script( 'velvet-theme-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), _S_VERSION, true );
}
